...
fn run_app() {
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::ai_secretary::secretary_round_status,
            commands::ai_secretary::complete_secretary_round,
            ...
            commands::ai_secretary::delete_ai_proposal,
            commands::ai_secretary::resolve_ai_proposal,
